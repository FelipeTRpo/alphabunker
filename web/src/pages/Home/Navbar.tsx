...
export const Navbar = (props: NavbarProps) => {
    ...
    return (
        <div className='flex flex-col gap-4 bg-brand-base p-12 rounded-b-3xl relative'>
            ...
            <nav>
                <ul className='flex gap-2 px-2 text-xs justify-around'>
            ...
            <div className=' rounded-2xl bg-white mx-auto my-0 px-4 py-3 pt-1.5 w-10/12 absolute -bottom-8 left-1/2 -translate-x-1/2 shadow-md flex flex-col items-start justify-between'>
