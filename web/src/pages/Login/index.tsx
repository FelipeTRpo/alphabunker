  ...
  return (
    <div className="w-full h-full bg-body-light-200 flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center p-2.5 gap-5">
        ...
        />
        <button onClick={handlerLogin} className="bg-brand-base font-brand hover:bg-btn-primary-hover text-btn-text rounded-md w-[250px] h-[40px]">
          Entrar
        </button>
        <p className="text-sm font-brand text-paragraph-dark" onClick={() => navigate("/register", { replace: true })}>Crie sua conta</p>
      </div>
    </div>
  );
};
